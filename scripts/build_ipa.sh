...
xcodebuild -exportArchive -exportFormat IPA -archivePath ./build/UIImageEffects.xcarchive -exportPath ./build/UIImageEffects.ipa -exportProvisioningProfile 'UIImageEffects Ad Hoc'
